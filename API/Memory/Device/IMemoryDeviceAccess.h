...
public:
	...
	virtual bool Write(const address_t absolute_address, const data_t data) = 0;
	virtual bool WriteDirectly(const address_t absolute_address, const data_t data) = 0;
};
} // API
