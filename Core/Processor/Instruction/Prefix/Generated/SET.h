...
auto SET_0xC6 = []()
{
	...
	return RunCommandAtAddress(HL_const, SET_REG_WITH_0);
};
...
auto SET_0xCE = []()
{
	...
	return RunCommandAtAddress(HL_const, SET_REG_WITH_1);
};
...
auto SET_0xD6 = []()
{
	...
	return RunCommandAtAddress(HL_const, SET_REG_WITH_2);
};
...
auto SET_0xDE = []()
{
	...
	return RunCommandAtAddress(HL_const, SET_REG_WITH_3);
};
...
auto SET_0xE6 = []()
{
	...
	return RunCommandAtAddress(HL_const, SET_REG_WITH_4);
};
...
auto SET_0xEE = []()
{
	...
	return RunCommandAtAddress(HL_const, SET_REG_WITH_5);
};
...
auto SET_0xF6 = []()
{
	...
	return RunCommandAtAddress(HL_const, SET_REG_WITH_6);
};
...
auto SET_0xFE = []()
{
	...
	return RunCommandAtAddress(HL_const, SET_REG_WITH_7);
};
