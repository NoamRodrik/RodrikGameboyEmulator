...
auto ADD_0x86 = []()
{
	return ADD_DATA_TO_REG_MUTATE_ZERO_FLAG(A, DataAt(HL_const));
};
...
auto ADD_0xC6 = []()
{
	return ADD_DATA_TO_REG_MUTATE_ZERO_FLAG(A, DataAt(IP_const + 1));
};
...
auto ADD_0xE8 = []()
{
	...
	return ADD_DATA_TO_REG_MUTATE_ZERO_FLAG(SP, D8_TO_R8(DataAt(IP_const + 1)), false);
};
} // Core
