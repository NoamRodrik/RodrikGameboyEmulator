...
// RRC reg
// Z 0 0 C
static constexpr auto RRC = [](auto& reg)
{
...
// 0x08 RRC B
// Z 0 0 C
static constexpr auto RRC_0x08 = []()
{
	return RRC(B);
};
...
// 0x09 RRC C
// Z 0 0 C
static constexpr auto RRC_0x09 = []()
{
	return RRC(C);
};
...
// 0x0A RRC D
// Z 0 0 C
static constexpr auto RRC_0x0A = []()
{
	return RRC(D);
};
...
// 0x0B RRC E
// Z 0 0 C
static constexpr auto RRC_0x0B = []()
{
	return RRC(E);
};
...
// 0x0C RRC H
// Z 0 0 C
static constexpr auto RRC_0x0C = []()
{
	return RRC(H);
};
...
// 0x0D RRC L
// Z 0 0 C
static constexpr auto RRC_0x0D = []()
{
	return RRC(L);
};
...
// 0x0E RRC (HL)
// Z 0 0 C
static constexpr auto RRC_0x0E = []()
{
...
// 0x0F RRC A
// Z 0 0 C
static constexpr auto RRC_0x0F = []()
{
	return RRC(A);
};
} // Core
