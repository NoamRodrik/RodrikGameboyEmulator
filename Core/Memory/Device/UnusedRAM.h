...
namespace Core
{
class UnusedRAM : public MemoryDeviceBase
{
public:
	constexpr UnusedRAM(DeviceManagerBase& device_manager) : MemoryDeviceBase{START_ADDRESS, END_ADDRESS, device_manager}, m_memory{} {}
...
public:
	static constexpr uint16_t START_ADDRESS = 0xFEA0;
	static constexpr uint16_t END_ADDRESS = 0xFEFF;
