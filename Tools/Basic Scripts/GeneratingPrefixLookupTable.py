...
with open("PrefixLookupTable.h", 'w+') as our_file:
  our_file.write("""/**
...
""")
  ...
  for short_name in short_name_table:
    if not len(short_name) == 0:
      our_file.write('#include <Core/Processor/Instruction/Prefix/Implementation/{}.h>\n'.format(short_name))
  
  our_file.write('\n')
  our_file.write('namespace Core\n')
  our_file.write('{\n')
  our_file.write("""static const std::array<Instruction, 0x10 * 0x10> PREFIX_LOOKUP_TABLE =
""")
  our_file.write('{\n')
  ...
  our_file.write('} // Core\n')
  our_file.write('\n')
  our_file.write('#endif // __PREFIX_LOOKUP_TABLE_H__')